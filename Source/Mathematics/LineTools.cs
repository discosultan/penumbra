...
namespace Penumbra.Mathematics
{
    ...
    /// </summary>
    internal static class LineTools
    {
        ...
        public static bool LineIntersect2(Vector2 a0, Vector2 a1, Vector2 b0, Vector2 b1, out Vector2 intersectionPoint)
        {
            ...
            if (Math.Abs(denom) < Calc.Epsilon)
            {
                                                        ...
                                                        Vertices intersectionPoints)
        {
            ...
            {
                Vector2 point;
                if (LineIntersect(vertices[i], vertices.NextElement(i),
        ...
        public static void LineSegmentAABBIntersect(ref Vector2 point1, ref Vector2 point2, AABB aabb,
                                                    Vertices intersectionPoints)
        {
            LineSegmentVerticesIntersect(ref point1, ref point2, aabb.Vertices, intersectionPoints);
        }
    }
}